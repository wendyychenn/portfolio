                ...
                <div>
                    <div style={{ paddingRight: "20rem", display: "flex", flexDirection: "column", textAlign: "left"}}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "2rem"}}>
                            <button className={`${styles.button}`}><a href='https://www.figma.com/file/WICpsIs0SVQjJQSog6Zguz/Mockup-for-Week-3?type=design&node-id=210%3A411&mode=design&t=ki0nOH6tRzP3Mo6U-1'>View Prototype</a></button>
